...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #093562;">
    ...
    <ul class="navbar-nav">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
                                ...
                                <button><li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/base/index2"style="color: white;">INICIO</a></li></button>
                                    <!-- <li class="nav-item">
                                    ...
                                    <button><li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/base/obj"style="color: white;">ACERCA DE CEPRA</a></li></button>
