    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php if (isset($empleado)): ?>
          <span style="color: white;"><strong>INTRUCTOR:</strong></span>
    <a href="#" class="d-block">
        <?php echo strtoupper($empleado->nombre . ' ' . $empleado->primerApellido . ' ' . $empleado->segundoApellido); ?>
    </a>
<?php else: ?>
    <a href="#" class="d-block">No se encontró al Instructor</a>
<?php endif; ?>
<!-- <pre><?php var_dump($empleado); ?></pre> -->
        </div>
      </div>
