    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="card shadow-sm p-4">
                ...
                <form action="<?= base_url('index.php/reportes/estudiantes_cursos') ?>" method="post" class="form-inline justify-content-center mb-4">
    ...
    <button type="submit" class="btn btn-primary mb-2 ml-2" title="Buscar suscripciones por fechas">
        <i class="fas fa-search"></i> Filtrar
                ...
                <div class="text-center">
                    <a href="<?= base_url('/index.php/reportes/generar_pdf?fecha_inicio=' . urlencode($fecha_inicio) . '&fecha_fin=' . urlencode($fecha_fin)); ?>" class="btn btn-success"><i class="fas fa-file-pdf"></i> Generar reportes</a>
