        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/estudiante/deshabilitados">Deshabilitados</a></li> 
...
<a href ="<?php echo base_url();?>index.php/estudiante/listaxls" target="_blank"><button type="submit" class="btn btn-success btn-block">lista de estudiantes en excel</button>   </a>   -->
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              if($foto=="")
                                {
                              ?>
                              <img width="100" src="<?php echo base_url(); ?>uploads/estudiantes/per.jpg">
                              <?php
                                }
                              else
                                {
