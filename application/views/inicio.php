...
<div class="content-wrapper">
  <!-- Content Header (Page header) -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <!-- <li><a href="<?php echo base_url(); ?>index.php/usuarios/logout"> <button type="button" class="btn btn-danger">CERRAR SESION</button> </a></li> -->
            </ol>
    ...
    <div class="col-md-5">
        <center><img src="<?php echo base_url(); ?>img/imgvt.png" width="300"></center>

        <!--      <svg class="" width="300" height="300" xmlns="" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false">
                                <title>imagen </title>

                               <rect width="100%" height="100%" fill="#eee" /><text x="50%" y="50%" fill="#aaa" dy=".3em">300x300</text>
