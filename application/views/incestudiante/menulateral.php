...
<!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #093562 ;" >
    <!-- Brand Logo -->
    <a href="<?php echo base_url(); ?>index.php/estudiante/index" class="brand-link">
...
<?php endif; ?>
<!-- <pre><?php var_dump($estudiante); ?></pre> -->
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>index.php/cursos/listadoc" class="nav-link">
