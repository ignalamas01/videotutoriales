...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logo_cepra.jpeg', 270, 5, 20); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE ESTUDIANTES INSCRITOS "), 0, 1, 'C', 0);
      $this->Ln(7);
